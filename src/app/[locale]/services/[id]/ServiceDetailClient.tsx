...
export default function ServiceDetailClient({ service, relatedServices, locale }: ServiceDetailClientProps) {
                        ...
                        {service.suitable_for && (
                            <section className="bg-white rounded-2xl p-8 shadow-sm">
                                ...
                                <div className="flex flex-wrap gap-3">
                                    {service.suitable_for.map((item: string, index: number) => (
                        ...
                        <div className="sticky top-32 space-y-6">
                            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-primary-teal">
                                ...
                                <div className="text-center mb-4">
                                    <div className="text-2xl font-bold text-primary-teal">Contact us for pricing</div>
                                </div>
                                ...
                                <a
                                    ...
                                    className="w-full bg-[#075E54] hover:bg-[#128C7E] text-white text-center font-bold py-4 rounded-full transition-all hover:shadow-lg flex items-center justify-center gap-2"
                                >
