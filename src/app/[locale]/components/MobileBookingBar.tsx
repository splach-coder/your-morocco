...
export default function MobileBookingBar({ whatsappUrl, text = "Book Now" }: MobileBookingBarProps) {
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 p-4 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] md:hidden">
            <div className="flex items-center justify-between gap-4">
                <div className="flex flex-col">
                    <span className="text-lg font-bold text-gray-900">Contact us for pricing</span>
                </div>
                <a
                    href={whatsappUrl}
                    target="_blank"
