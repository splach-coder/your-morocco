        ...
        <>
            ...
            <div className="fixed bottom-6 right-6 z-50">
                ...
                >
                    ...
                    <div
                        className={`absolute right-0 h-16 bg-[#25D366] group-hover:bg-[#20bd5a] rounded-full shadow-2xl transition-all duration-300 ${isOpen ? 'w-auto pr-20 pl-6 opacity-100' : 'w-16 pr-0 pl-0 opacity-0'
                            }`}
                    >
                    ...
                    <div className="relative w-16 h-16 bg-[#25D366] group-hover:bg-[#20bd5a] rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 group-hover:scale-110 z-10">
                        <svg
                        ...
                        {/* Pulse Animation - only on the circle */}
