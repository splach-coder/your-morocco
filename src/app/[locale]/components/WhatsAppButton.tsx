        ...
        <>
            ...
            <div className="fixed bottom-6 right-6 z-50">
                <a
                    ...
                    className="group relative flex items-center gap-3 bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-full shadow-2xl transition-all duration-300 hover:scale-110"
                ...
                >
                    ...
                    {/* Expandable Text */}
                    <div
                        className={`overflow-hidden transition-all duration-300 ${isOpen ? 'max-w-xs pr-6' : 'max-w-0'
                            }`}
                    >
